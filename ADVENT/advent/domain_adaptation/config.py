...
cfg.TRAIN.MASTER_ADDR = '10.5.53.66'
cfg.TRAIN.MASTER_PORT = '8888'
...
# NVP params
cfg.TRAIN.NVP = EasyDict()
cfg.TRAIN.NVP.NUM_SCALES = 2
cfg.TRAIN.NVP.MID_CHANNELS = 64
cfg.TRAIN.NVP.NUM_BLOCKS = 8
cfg.TRAIN.NVP.RESTORE_FROM = ""
cfg.TRAIN.NVP.LAMBDA_NVP = 1e-5
